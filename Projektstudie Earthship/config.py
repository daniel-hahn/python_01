...
weather_data_t2m_nc = "earthship_model/upload/data/data_24-25_t2m.nc"
weather_data_ssrd_nc= "earthship_model/upload/data/data_24-25_ssrd_accum.nc"
weather_data_wind_u_nc= "earthship_model/upload/data/data_24-25_wind_u10.nc"
weather_data_wind_v_nc= "earthship_model/upload/data/data_24-25_wind_v10.nc"
...
green_wall_factor = 0.8 # 0.6               # reduces wind speed
...
#F_W = 0.9                                   # 0.9, Abminderung nicht senkrechter Einfall, redundant
...
ventilation_rate_day = 0.15                  # Air Changes per Hour (ACH)
